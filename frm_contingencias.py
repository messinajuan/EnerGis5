...
class frmContingencias (DialogType, DialogBase):
    ...
    def importar(self):
        ...
        if rs[0] == 0:
            ...
            try:
                ...
                cnn.rollback()
                QMessageBox.warning(self, "EnerGis 5", "No se pudieron insertar Reclamos ! " + str_sql)
        self.lblContingencia.setText(str(self.ult_contingencia))
        #except:
        #    QMessageBox.warning(self, "EnerGis 5", "No se pudieron insertar los Reclamos !")
        #    pass
    ...
    def registrar(self):
        ...
        f = open('c:/gis/energis5/log_operaciones.txt','a')
        f.writelines('-------------------------------------' + '\n')
        f.close()
        #----------------------------------------------------------------------------
        ...
        for n in range (0, len(contingencias)):
            ...
            if tipo_elemento=="Elem_ManiobraMT":
                ...
                if len(nodo)==0:
                    ...
                    #except:
                    #    self.conn.rollback()
                    #    QMessageBox.warning(self, "EnerGis 5", "No se pudo cargar la Operacón del Elemento ! id:" + str(id) + " - " + str_valores)
    ...
    def afectados(self, aux):
        ...
        try:
            ...
            QMessageBox.information(self, "EnerGis 5", "Error al calcular suministros afectados !")
